<template>
  <div class="header">
    ...
    <!--模态框-->
    <transition appear name="csq" enter-active-class="animated bounceInDown" leave-active-class="animated bounceOutUp">
      <div v-if="detailModalShow" class="header__detail">
        <div class="header__detail__wrapper">
          <div class="header__detail__main">
            ...
            <!--标题组件-->
            <tit tit="商家公告"></tit>
            <div class="header__detail__notice">
              {{seller.bulletin}}
            </div>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      classMap: ['special', 'discount', 'special', 'invoice', 'guarantee']
    }
  },
  methods: {
    showDetailModal() {
